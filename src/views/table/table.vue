      ...
      <el-col :span="24">
        ...
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          ...
          <el-form-item label="关键字">
            <el-input expand-trigger="hover" placeholder="关键字" v-model="formInline.user.code"></el-input>
          </el-form-item>
          <el-form-item label="类型">
            <el-select v-model="formInline.user.place" placeholder="请选择">
              <el-option>散文</el-option>
            </el-select>
          </el-form-item>
        ...
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column prop="code" label="地址"> </el-table-column>
...
//          this.tableData[this.table_index] = this.form;
      ...
      download: function() {
        ...
        for (var i = 0; i < this.tableData.length; i++) {
          ...
          str += item.name + ',' + item.date + ',' + item.code;
          str += "\n";
        }
        console.log(obj)
